...
if __name__ == '__main__':
    ...
    (x_train, _), (_, _), data_df = dataloader.load_HDFS(struct_log, window='session', 
    ...
    (x_test, _), (_, _), data_df = dataloader.load_HDFS(struct_log, window='session', split_type='sequential')
